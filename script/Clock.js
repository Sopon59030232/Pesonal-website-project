(function () {
    'use strict';
    var canvas = document.querySelector('#clockFace'),
        canvasContext = canvas.getContext('2d'),
        btnDefault = document.querySelector('#clockDefault'),
        btnAnother = document.querySelector('#clockAnother'),
        //clock settings
        cX = canvas.width / 2,
        cY = canvas.width / 2,
        endX,
    ...
    function drawNumber() {
        ...
        canvasContext.fillStyle = "#313131";
